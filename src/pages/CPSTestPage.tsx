        ...
        <>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 'clamp(1.9rem, 5.5vw, 3rem)', fontWeight: '900', color: 'var(--neon-cyan)', marginBottom: '0.05rem', fontVariantNumeric: 'tabular-nums' }}>
              {cps} <span style={{ fontSize: '1rem', color: 'var(--text-secondary)' }}>CPS</span>
            </div>
            <div style={{
            ...
            {/* CPS Rating Scale */}
            <div style={{ textAlign: 'left', background: 'rgba(0,0,0,0.3)', borderRadius: '12px', padding: '0.4rem', marginBottom: '0.45rem', border: '1px solid rgba(0,245,255,0.2)' }}>
              <div style={{ fontSize: '0.6rem', color: 'var(--text-muted)', marginBottom: '0.2rem', textTransform: 'uppercase', letterSpacing: '0.1em', fontWeight: '600' }}>CPS Rating Scale</div>
              {[
                ...
                <div key={r.range} style={{ display: 'flex', justifyContent: 'space-between', padding: '0.1rem 0', fontSize: '0.6rem', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
            ...
            <div style={{ display: 'flex', gap: '0.4rem', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '0.1rem' }}>
              <button className="btn btn-secondary" onClick={() => resetTest()} style={{
                animation: 'slideUp 0.4s ease-out 0.1s both', padding: '0.35rem 0.8rem', fontSize: '0.8rem'
              }}>🔄 Reset</button>
              <button className="btn btn-primary" onClick={() => {
                resetTest();
                setTimeout(() => startTest(), 300);
              }} style={{
                animation: 'slideUp 0.4s ease-out 0.2s both', padding: '0.35rem 0.8rem', fontSize: '0.8rem'
              }}>▶ Try Again</button>
            </div>
          </div>
