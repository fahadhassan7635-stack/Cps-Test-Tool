...
const DATA = {
  cps: [
    ...
    { rank: 6, name: 'Clickking420', score: '12.4 CPS', country: '🇬🇧', avatar: '👾', badge: '' },
  ...
  wpm: [
    { rank: 1, name: 'Typeking', score: '187 WPM', country: '🇺🇸', avatar: '⌨️', badge: 'Speed Typist' },
  ...
  reaction: [
    { rank: 1, name: 'Reflexking', score: '118ms', country: '🇰🇷', avatar: '⚡', badge: 'Flash' },
  ...
  aim: [
    ...
    { rank: 4, name: 'Aimking420', score: '431 hits', country: '🇬🇧', avatar: '💎', badge: '' },
