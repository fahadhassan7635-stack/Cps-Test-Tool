...
const getRating = (ms: number) => {
  if (ms < 80)  return { label: 'ðŸ”¥ Lightning', color: 'var(--neon-red)'       };
  if (ms < 150) return { label: 'âš¡ Fast',      color: 'var(--neon-orange)'    };
  if (ms < 250) return { label: 'âœ… Normal',    color: 'var(--neon-green)'     };
  return              { label: 'ðŸ¢ Slow',       color: 'var(--text-secondary)' };
};
...
// â”€â”€â”€ Sound engine (Web Audio API â€” no external files needed) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function useClickSounds(enabled: boolean) {
  ...
  const tone = useCallback((freqStart: number, freqEnd: number, duration: number, volume: number, type: OscillatorType = 'sine') => {
    ...
    try {
      ...
      // Audio blocked or unsupported â€” fail silently, never break the UI
    }
  }, [enabled, getCtx]);
...
const FAQ_ITEMS = [
  ...
  { q: 'What is the default double-click speed in Windows?',        a: 'Windows defaults to a 500 ms threshold. You can adjust it in Control Panel â†’ Mouse â†’ Buttons â†’ Double-click speed.' },
  { q: 'What is the default double-click speed on macOS?',          a: 'macOS uses a similar ~500 ms default. Change it in System Preferences â†’ Accessibility â†’ Pointer Control â†’ Double-click speed.' },
  { q: 'How do I change double-click speed on Linux?',              a: 'On GNOME, use: gsettings set org.gnome.desktop.peripherals.mouse double-click <ms>. KDE users can adjust it in System Settings â†’ Input Devices â†’ Mouse.' },
  ...
  { q: 'What is the best double-click speed for gaming?',           a: 'For most games, 80â€“150 ms is ideal. It is fast enough to execute rapid actions without risking misregistration from the operating system.' },
  ...
  { q: 'Is double-click testing accurate in a browser?',            a: 'Browser accuracy is within 1â€“4 ms due to the performance.now() API. System load and browser background tasks can introduce minor variance.' },
  ...
  { q: 'What is the average human double-click interval?',          a: 'The average person double-clicks within 200â€“300 ms. Trained gamers typically achieve 80â€“150 ms, while elite players can reach under 80 ms.' },
  { q: 'What mouse switches last the longest?',                     a: 'Optical switches have no mechanical wear and are rated for 100 million+ clicks. Traditional Omron mechanical switches are rated for 20â€“50 million clicks before chatter risk increases.' },
  { q: 'Why does this test play a sound when I click?',             a: 'A short tone plays on the first click, a rising chime confirms a successful double-click, and a low buzz plays on a failed attempt â€” giving you audio feedback without needing to watch the screen.' },
  ...
  { q: 'Is there a world record for double-click speed?',           a: 'There is no single certified world record, but community leaderboards on gaming forums have documented verified double-clicks in the 20â€“40 ms range using optical switches and high-speed capture equipment.' },
...
// â”€â”€â”€ SEO head injection (no next/head needed) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function useSEOHead() {
  useEffect(() => {
    // Title
    document.title = 'Double Click Test â€” Measure Your Double-Click Speed in ms';
    ...
    setMeta('meta[property="og:title"]',        'property', 'og:title',            'Double Click Test â€” Measure Your Double-Click Speed in ms');
    ...
    setMeta('meta[name="twitter:title"]',       'name',     'twitter:title',       'Double Click Test â€” Measure Your Double-Click Speed in ms');
...
// â”€â”€â”€ Ripple Component â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export default function DoubleClickPage() {
  ...
  const handleClick = useCallback((e: React.MouseEvent<HTMLDivElement>) => {
    ...
    if (lastClick.current > 0 && diff < THRESHOLD) {
      ...
      setStatus(`âœ… Double click! ${ms}ms interval`);
      lastClick.current = 0;
      ...
      setStatus('ðŸ–±ï¸ Click again quickly!');
      playArm();
      setTimeout(() => {
        if (performance.now() - lastClick.current >= THRESHOLD) {
          setStatus('â±ï¸ Too slow â€” try again!');
          lastClick.current = 0;
          playFail();
        }
      }, THRESHOLD);
  ...
  return (
    <div style={{ maxWidth: '700px', margin: '0 auto', padding: '2rem 1.5rem' }}>
      ...
      {/* â”€â”€â”€ Difficulty Selector â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <div style={{ marginBottom: '1.5rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.6rem' }}>
          <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: '700' }}>
            Difficulty â€” Current threshold:{' '}
      ...
      {/* â”€â”€â”€ Top Stats â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem', marginBottom: '1.5rem' }}>
        {[
          { value: lastInterval ? `${lastInterval}ms` : 'â€”', label: 'Last Interval', color: 'var(--neon-cyan)'   },
          { value: avg          ? `${avg}ms`          : 'â€”', label: 'Average',       color: 'var(--neon-green)'  },
          { value: best         ? `${best}ms`         : 'â€”', label: 'Best',          color: 'var(--neon-orange)' },
        ].map(s => (
      ...
      {/* â”€â”€â”€ Click Zone â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <div
        ref={zoneRef}
        onClick={handleClick}
        role="button"
      ...
      >
        ...
        <span style={{ fontSize: '3rem', position: 'relative', zIndex: 1 }}>ðŸ–±ï¸</span>
      ...
      {/* â”€â”€â”€ Statistics Panel â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: '16px', overflow: 'hidden', marginBottom: '1.5rem' }}>
        <div style={{ padding: '0.75rem 1.25rem', borderBottom: '1px solid var(--border)', fontWeight: '700', fontSize: '0.85rem', color: 'var(--neon-cyan)' }}>
          ðŸ“ˆ Statistics
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)' }}>
          {[
            ...
            { label: 'Success Rate',    value: stats.totalAttempts ? `${successRate}%` : 'â€”',                    color: 'var(--neon-orange)'  },
            { label: 'Median',          value: medianVal  != null ? `${medianVal}ms`  : 'â€”',                     color: 'var(--neon-cyan)'    },
            { label: 'Slowest',         value: slowest    != null ? `${slowest}ms`    : 'â€”',                     color: 'var(--text-muted)'   },
            { label: 'Std Deviation',   value: stdDevVal  != null && results.length ? `${stdDevVal}ms` : 'â€”',    color: '#a78bfa'             },
      ...
      <section style={{ color: 'var(--text-secondary)', fontSize: '0.92rem', lineHeight: '1.75' }}>
        ...
        <ul style={{ paddingLeft: '1.25rem', marginBottom: '1.5rem', listStyleType: 'disc' }}>
          <li style={{ marginBottom: '0.6rem' }}><strong style={{ color: 'var(--neon-red)' }}>âš¡ Lightning (&lt; 80ms):</strong> Elite reflex speed. Often achieved by competitive gamers using high-performance optical switches with minimal de-bounce delay.</li>
          <li style={{ marginBottom: '0.6rem' }}><strong style={{ color: 'var(--neon-orange)' }}>ðŸš€ Fast (80ms - 150ms):</strong> Excellent mechanical performance. Perfect for snappy productivity mapping and rapid execution queues.</li>
          <li style={{ marginBottom: '0.6rem' }}><strong style={{ color: 'var(--neon-green)' }}>âœ… Normal (150ms - 250ms):</strong> The global human average benchmark. Ideal for everyday web browsing and standard application usage.</li>
          <li style={{ marginBottom: '0.6rem' }}><strong style={{ color: 'var(--text-muted)' }}>ðŸ¢ Slow (&gt; 250ms):</strong> Might cause software applications to misinterpret double-clicks as two separate individual actions.</li>
        </ul>
        ...
        <ol style={{ paddingLeft: '1.25rem', marginBottom: '1.5rem' }}>
          ...
          <li style={{ marginBottom: '0.5rem' }}>Click the large zone once â€” the status changes to prompt a second click, and a short arming tone confirms the first press was registered.</li>
        ...
        <p style={{ marginBottom: '1.5rem' }}>
          This tool now includes built-in audio feedback generated live in your browser using the Web Audio API â€” no sound files are downloaded, so there is zero added page weight. A short, low <strong>arming tick</strong> plays the instant your first click registers, letting you know the timer has started without needing to glance at the status text. If your second click lands inside the threshold, a bright <strong>rising chime</strong> confirms a successful double-click. If you miss the window, a low descending <strong>buzz</strong> tells you the attempt failed. All three cues are generated with oscillators rather than audio files, so they load instantly and work offline. A dedicated <strong>Sound On / Sound Off</strong> toggle sits above the difficulty selector if you would rather test in silence â€” useful in shared offices, libraries, or late-night sessions.
        </p>
        ...
        <p style={{ marginBottom: '1.5rem' }}>
          Competitive gamers â€” especially those playing Minecraft PvP, shooters, or real-time strategy games â€” aim for double-click intervals of <strong>80â€“150 ms</strong>. This range is fast enough to outmaneuver opponents while remaining reliable and unlikely to be misinterpreted as a single click. Elite players using optical-switch gaming mice routinely achieve sub-80 ms intervals. If you are a casual gamer, 150â€“250 ms is perfectly adequate for most titles.
        </p>
        ...
        <ol style={{ paddingLeft: '1.25rem', marginBottom: '1.5rem' }}>
          <li style={{ marginBottom: '0.5rem' }}><strong>Increase OS debounce threshold</strong> â€” raise the double-click speed slider to a slower setting so the OS ignores rapid re-activations.</li>
          <li style={{ marginBottom: '0.5rem' }}><strong>Use peripheral software</strong> â€” tools like Logitech G Hub or Razer Synapse offer a debounce filter setting in milliseconds.</li>
          <li style={{ marginBottom: '0.5rem' }}><strong>Clean the switch</strong> â€” apply isopropyl alcohol (90%+) to the switch and click rapidly to flush debris.</li>
          <li style={{ marginBottom: '0.5rem' }}><strong>Replace the switch</strong> â€” Omron D2FC-F-7N switches cost under $2 and are solderable by anyone with basic skills.</li>
          <li style={{ marginBottom: '0.5rem' }}><strong>Update firmware/drivers</strong> â€” manufacturers occasionally patch switch chatter bugs via driver updates.</li>
        </ol>
        ...
        <p style={{ marginBottom: '1.5rem' }}>
          On Windows 10 and 11, navigate to <strong>Control Panel â†’ Hardware and Sound â†’ Mouse â†’ Buttons tab</strong>. The <em>Double-click speed</em> slider adjusts the time window from approximately 200 ms (Fast) to 900 ms (Slow). Moving the slider left increases the threshold, making it easier to register double-clicks. For gaming, a medium-to-fast setting (~400â€“500 ms) provides the best balance of responsiveness and accuracy.
        </p>
        ...
        <p style={{ marginBottom: '1.5rem' }}>
          On macOS Ventura and later, go to <strong>System Settings â†’ Accessibility â†’ Pointer Control</strong>. The <em>Double-click speed</em> slider lets you increase or decrease the recognition window. Earlier macOS versions use <strong>System Preferences â†’ Accessibility â†’ Mouse &amp; Trackpad â†’ Double-click speed</strong>. The default value is approximately 500 ms.
        </p>
        ...
        <p style={{ marginBottom: '1.5rem' }}>
          Linux users can configure double-click speed via the desktop environment or terminal. On <strong>GNOME</strong>, run: <code>gsettings set org.gnome.desktop.peripherals.mouse double-click 400</code> (value in ms). On <strong>KDE Plasma</strong>, go to System Settings â†’ Input Devices â†’ Mouse â†’ Advanced. For <strong>X11</strong>, use <code>xset m</code> or edit <code>/etc/X11/xorg.conf</code>.
        </p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1rem', marginBottom: '1.5rem' }}>
          {[
            { title: 'âš™ï¸ Mechanical Switches', points: ['Physical metal contacts', 'Susceptible to oxidation and chatter', 'Rated 20â€“50M clicks (Omron)', 'Lower cost', 'Tactile feedback'] },
            { title: 'ðŸ’¡ Optical Switches',    points: ['Light-beam actuation', 'Zero bounce â€” no chatter', 'Rated 100M+ clicks', 'Higher upfront cost', 'Consistent every time'] },
          ].map(col => (
        ...
        <ul style={{ paddingLeft: '1.25rem', marginBottom: '1.5rem', listStyleType: 'disc' }}>
          ...
          <li style={{ marginBottom: '0.6rem' }}><strong>Upgrade your switch:</strong> Optical switches eliminate bounce delay, shaving off 5â€“15 ms of effective debounce time.</li>
        ...
        <p style={{ marginBottom: '1.5rem' }}>
          While there is no single official governing body certifying double-click speed the way there is for typing tests, many esports organizations and hardware manufacturers publish informal benchmarks for their sponsored athletes. Competitive click-intensive titles have driven demand for input devices with sub-1ms polling response and near-zero debounce delay, which is why optical switches have become the de facto standard in high-end gaming mice over the past several years. Community leaderboards on gaming forums have documented verified double-clicks as fast as 20â€“40 ms using specialized capture equipment, though such results sit well outside what casual play requires.
        </p>
        ...
        <p style={{ marginBottom: '1.5rem' }}>
          A single double-click score is only a snapshot. The real value of this tool comes from testing repeatedly over time â€” before and after cleaning a switch, before and after upgrading to an optical-switch mouse, or simply across a few days to see how consistent your natural reflex timing really is. Pay closer attention to your standard deviation and success rate than to any single best result: a low best time paired with a high failure rate usually means you got lucky once rather than developed genuine consistency. Combine the sound feedback with the visual stats, work your way up through the difficulty levels gradually, and use the troubleshooting table above the moment you notice anything unusual in your numbers. Whether you are diagnosing a flaky switch, tuning your operating system's threshold, or simply curious how your reflexes compare to the global average, this tool gives you a fast, private, and completely free way to find out. Bookmark this page and revisit it every few weeks â€” small, gradual improvements in your average interval are far more meaningful than chasing a single lucky lightning-fast click, and tracking that trend over time is the best way to know whether your hardware, technique, or both are actually getting better.
        </p>

        {/* â”€â”€ Expanded FAQ â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
