...
export default function TermsPage() {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '4rem 1.5rem', color: 'var(--text-primary)', lineHeight: '1.8' }}>
      <Link href="/" style={{ color: 'var(--neon-cyan)', textDecoration: 'none', fontSize: '0.9rem', display: 'inline-flex', alignItems: 'center', gap: '0.5rem', marginBottom: '2rem', fontWeight: '600' }}>
        ← Back to Home
      </Link>
      ...
      <div style={{ color: 'var(--text-secondary)', fontSize: '1rem' }}>
        ...
        <p>
          ...
          our{' '}
          <Link href="/privacy-policy" style={{ color: 'var(--neon-cyan)', textDecoration: 'none' }}>
            Privacy Policy
